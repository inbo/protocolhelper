# Getting help with protocolhelper

Thanks for using protocolhelper. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/protocolhelper/issues) to make sure the 
