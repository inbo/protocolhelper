...
```{r}
bs_carousel(id = "Voorbeelden", use_indicators = TRUE) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld1.png"),
      alt = "Vervangprotocol"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld2.jpeg"),
      alt = "Vegetatieopname"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld3.png"),
      alt = "Navigatie"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld4.jpg"),
      alt = "Bodemstaalnamemateriaal"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld5.png"),
      alt = "Peilbuizen"
    )
  ) %>%
  bs_append(
    content = bs_carousel_image(
      src = image_uri("voorbeeld6.jpg"),
      alt = "Bodemstaal"
    )
  )
```
